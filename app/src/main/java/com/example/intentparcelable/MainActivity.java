    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case  R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME,"Intan Nurlatifah");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE,"17");
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Intan Nurlatifah");
                mPerson.setAge(17);
                mPerson.setEmail("intannurlatifah2002@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "085759275071";
